...
RERANK_RELEVANCE_THRESHOLD = -10.0
        ...
        try:
            ...
            if reranked:
                ...
                logger.info(
                    ...
                    f"avg: {avg_score:.3f}, threshold: {RERANK_RELEVANCE_THRESHOLD}"
                )

                if top_score < RERANK_RELEVANCE_THRESHOLD and avg_score < RERANK_RELEVANCE_THRESHOLD:
